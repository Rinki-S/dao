...
function FieldLabel({ className, ref, ...props }) {
  return (
    <Label
      ...
      className={cn(
        'group/field-label peer/field-label flex w-fit gap-2 rounded-md leading-snug group-data-[disabled=true]/field:opacity-50 has-data-checked:bg-primary/5 has-[>[data-slot=field]]:border *:data-[slot=field]:p-2 dark:has-data-checked:bg-primary/10',

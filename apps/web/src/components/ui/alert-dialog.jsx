...
export function AlertDialogPopup({ className, bottomStickOnMobile = true, portalProps, ...props }) {
  return (
...
export function AlertDialogFooter({ className, variant = 'default', ...props }) {
  return (
    <div
      className={cn(

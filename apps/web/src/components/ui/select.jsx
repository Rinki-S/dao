      ...
      >
        <SelectPrimitive.Popup
          className={cn(
            ...
            'transition-[scale,opacity] duration-(--duration-overlay) ease-out data-starting-style:scale-98 data-starting-style:opacity-0 data-ending-style:scale-98 data-ending-style:opacity-0',
          )}
